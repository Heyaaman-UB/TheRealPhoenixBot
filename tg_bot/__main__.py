...
from KittuRobot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from KittuRobot.modules import ALL_MODULES
from KittuRobot.modules.helper_funcs.chat_status import is_user_admin
from KittuRobot.modules.helper_funcs.misc import paginate_modules
...
If you have any questions on how to use me, head over to @CFC_BOT_support
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KittuRobot.modules." + module_name)
